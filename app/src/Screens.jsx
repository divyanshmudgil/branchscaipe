...
import { Pill, Switch, Tabs } from "./design-system/components/core/index.js";
import { Input, Select } from "./design-system/components/forms/index.js";
...
// ── CommandPalette ────────────────────────────────────────────────────────────
export function CommandPalette({ branches, onPick }) {
...
// ── SettingsBody ──────────────────────────────────────────────────────────────
export function SettingsBody({ theme, setTheme, density, setDensity, autoMerge, setAutoMerge }) {
  return (
...
export function MergeBody({ scope, source, targets, target, setTarget }) {
...
// ── SelectionMenu ─────────────────────────────────────────────────────────────
export function SelectionMenu({ x, y, onBranch, onCopy, onClose }) {
  const ref = React.useRef(null);
  React.useEffect(() => {
    const h = (e) => { if (ref.current && !ref.current.contains(e.target)) onClose(); };
    document.addEventListener("mousedown", h);
