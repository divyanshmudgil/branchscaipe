...
function Response({ msg, inBranch, onAction, onContextMenu, onSelectText, registerRef }) {
...
// ── MergeDivider ──────────────────────────────────────────────────────────────
function MergeDivider({ source, ts, scope, onJump }) {
  const I = window.BscIcon;
...
// ── BranchOriginBanner ────────────────────────────────────────────────────────
function BranchOriginBanner({ parentName, seed, onJump }) {
  const I = window.BscIcon;
  return (
