...
window.BSC_DATA = { rootId: null, branches: {} };
...
function generateReply({ branch, userText, contextTopics, merged, retry }) {
...
window.BSC = { uid, lineage, contextMessages, autoName, relTime, generateReply };
